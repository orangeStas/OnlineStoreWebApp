...
import by.epam.task6.service.impl.EditProductService;
 ...
 * First part of logic for saving new properties of editing product
...
public class EditProductCommand implements Command {
    ...
    public String execute(HttpServletRequest request) throws CommandException {
        ...
        if (validateParameters(request)) {
            ...
            GenericService<Product, Boolean> editProductService = EditProductService.getInstance();
            ...
            try {
                ...
                if (request.getPart(RequestParameterName.IMAGE).getInputStream().available() != 0){
                    ...
                    product.setImagePath(request.getParameter(RequestParameterName.OLD_IMAGE));
                }

                editProductService.execute(product);
                page = JspPageName.PROFILE;
            } catch (ServiceException | ServletException | IOException e) {
                throw new CommandException("Edit product command exception", e);
            }
        }
        else {
